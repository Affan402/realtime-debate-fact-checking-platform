...
export default function ArgumentsPage() {
  ...
  const arguments_ = rawArgs.map((arg: any) => ({
    ...
    reactions: 0,
    strength: (arg.credibilityScore >= 0.7 ? "strong" : arg.credibilityScore >= 0.4 ? "medium" : "weak") as "strong" | "medium" | "weak",
    hasWarning: Boolean(arg.fallacy && arg.fallacy !== "None" && !(typeof arg.fallacy === "object" && Object.keys(arg.fallacy).length === 0)),
    warningType: (arg.fallacy && arg.fallacy !== "None" && !(typeof arg.fallacy === "object" && Object.keys(arg.fallacy).length === 0) ? "fallacy" : undefined) as "fallacy" | undefined,
    factCheckStatus: {
      isChecking: false,
      hasIssue: arg.credibilityScore < 0.7,
      issueType: (arg.credibilityScore >= 0.7 ? "verified" : arg.credibilityScore >= 0.4 ? "disputed" : "low-credibility") as "verified" | "disputed" | "low-credibility",
    },
    fallacy: arg.fallacy,
